...
{
	blackThreatArray = backUpBlackThreatArray;
	whiteThreatArray = backUpWhiteThreatArray;
	pieceArray[m_lastStart] = pieceArray[m_lastTarget];
	pieceArray[m_lastTarget] = m_lastPiece;
	m_bKing = m_lastBKing;
	m_wKing = m_lastWKing;
	for (int i = 0; i < 64; i++)
	{
